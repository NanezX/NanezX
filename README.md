<h1 align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&duration=4000&pause=1000&color=6366F1&center=true&vCenter=true&random=false&width=600&lines=Hey+there!+I'm+V%C3%ADctor+%F0%9F%91%8B;Fullstack+Developer;DevOps+Engineer;Web3+Developer;AI%2FLLM+Solutions+Builder" alt="Typing SVG" />
</h1>
...
These days, I'm focused on **AI/LLM solutions** — working with local and cloud models (Ollama, OpenAI), building proxies between apps and LLMs, and creating tools that make complex tech accessible to everyone.

I'm passionate about **side projects** and believe in **never stopping learning** — whether it's exploring a new framework, reading docs late at night, or experimenting with the latest tech. Building things is what keeps me going! 🚀

- 🔭 Currently building **AI-powered applications**
- 🌱 Always exploring **new LLM integrations** and **developer tooling**
- 💬 Ask me about **Svelte, TypeScript, Rust, Python, Bash, or Nix**
- 🌍 Based in Monagas, Venezuela
- 🗣️ **Spanish** (Native) | **English** (C1) | **Italian** (A1)
